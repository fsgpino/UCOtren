...
-(void) viewDidLoad
{
    ...
    origenSalidasCordobaARabanales = [[dataFile objectAtIndex:4] componentsSeparatedByString: @"|"];
    ...
    if((TotalSegundosActual > [self StringASegundos:[origenSalidasCordobaARabanales objectAtIndex:ultimoValorHorario]])||(DiaSemanaActual==6)||(DiaSemanaActual==7))
    {
        ...
        while(TotalSegundosActual > [self StringASegundos:[origenSalidasCordobaARabanales objectAtIndex:contadorAuxiliar]])
        {
            contadorAuxiliar++;
        }
    }
